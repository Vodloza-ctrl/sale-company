/**
 * scz-checkout.js — shared EcoCash-push checkout module for sale.co.zw
 * ---------------------------------------------------------------------------
 * Extracted from the Bookings addon purchase flow (sale-bookings-worker.js
...
(function (global) {
  ...
  function defaultToast(msg) {
    ...
    if (typeof console !== "undefined") console.log("[scz-checkout]", msg);
  }
