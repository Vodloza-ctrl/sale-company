/**
 * sale.co.zw — AI Content Generation Worker  v2.1
...
const DEFAULT_APP_ORIGIN  = "https://app.sale.co.zw";
...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === "/health")
      return json({ ok: true, service: "sale-cozw-ai", version: "2.2" }, 200, origin);
